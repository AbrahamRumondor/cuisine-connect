...
class SavedRecipeFragment : Fragment() {
  ...
  override fun onCreateView(
    ...
    val view = inflater.inflate(R.layout.fragment_saved_recipe_list, container, false)
    ...
    if (view is RecyclerView) {
      ...
      with(view) {
        ...
        adapter = SavedRecipeRecyclerViewAdapter(PlaceholderContent.ITEMS)
      }
